 ...
 export type ContentCategory = 'tech' | 'finance' | 'politics' | 'climate';
 ...
 export const DEFAULT_RATIOS: RatioConfig[] = [
   { category: 'tech', targetRatio: 0.68, subCategories: ['ai', 'apple', 'tesla', 'crypto', 'general'] },
   { category: 'finance', targetRatio: 0.16, subCategories: ['markets', 'banking', 'investing', 'economy'] },
   { category: 'politics', targetRatio: 0.08, subCategories: ['government', 'elections', 'policy', 'international'] },
   { category: 'climate', targetRatio: 0.08, subCategories: ['environment', 'energy', 'sustainability'] },
 ];
 ...
 export const CATEGORY_KEYWORDS: Record<ContentCategory, Record<string, string[]>> = {
   tech: {
     ...
     general: [
       ...
       'youtube', 'netflix', 'streaming', 'gaming', 'playstation', 'xbox',
       'nintendo', 'steam', 'epic games', 'unity', 'unreal', 'vr', 'ar',
       'metaverse', 'cybersecurity', 'hacking', 'data breach', '5g', '6g',
       'semiconductor', 'chip', 'nvidia', 'amd', 'intel', 'qualcomm', 'tsmc'
     ]
   },
   finance: {
     markets: [
